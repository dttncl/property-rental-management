...
namespace property_rental_management.Controllers
{
    public class MessagesController : Controller
    {
        ...
        public MessagesController(RentaSpaceDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("MessageId,ManagerId,TenantId,Message1")] Message message)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MessageId,ManagerId,TenantId,Message1")] Message message)
        {
